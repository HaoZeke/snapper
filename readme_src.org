...
This convention, often called [[https://sembr.org/][semantic line breaks]], enjoys longstanding support from technical writers.
...
See [[file:docs/orgmode/howto/mcp-integration.org][MCP Integration]] for configuration.
** Supported formats
:PROPERTIES:
